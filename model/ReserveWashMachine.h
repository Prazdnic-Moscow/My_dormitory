...
public:
    ...
    void setMachineId(int& machineid) { machineId = machineid; }
    void setDate(const std::string& datee) { date = datee; }
    void setStartTime(const std::string& starttime) { startTime = starttime; }
    void setDuration(float durationn) { duration = durationn; }
};
